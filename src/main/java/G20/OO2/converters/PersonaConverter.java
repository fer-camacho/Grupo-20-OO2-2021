...
public class PersonaConverter {
	public PersonaModel entityToModel(Persona entity) {
		return new PersonaModel(entity.getId(), entity.getNombre(), entity.getApellido(), entity.getTipo(), entity.getNroDocumento());
	}
	
	public Persona modelToEntity(PersonaModel model) {
		return new Persona(model.getId(), model.getNombre(), model.getApellido(), model.getTipo(), model.getNroDocumento());
	}
}
