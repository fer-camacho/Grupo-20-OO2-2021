...
public class PermisoConverter {
	...
	/*
	public PermisoDiarioModel entityToModelconLugar(PermisoDiario entity) {
			return new PermisoDiarioModel(entity.getIdPermiso(), personaConverter.entityToModel(entity.getPedido()), entity.getFecha(), lugarConverter.entityToModel(entity.getDesdeHasta()), entity.getMotivo());
	}*/
